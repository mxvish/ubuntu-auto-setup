...
mv Public .Public
rm -r Template Documents Music Pictures Videos
...
mv ダウンロード .Downloads
mv 公開 .Public
rm -r テンプレート ドキュメント ミュージック ピクチャ ビデオ
"""
...
emacs
	M-x package install <RET> company auto-highlight-symbol emmet-mode

brave-browser
	bravepasswd from onedrive
  	remove all history & autofill form data on exit
	Don't allow sites to send notifications
	sync everything (expect for open tabs)
	appearance=dark
	enable
